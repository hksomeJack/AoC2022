...
Part 2:
    Still lots of work despite the prioritizing plan -- time to find ALL overlapping tasks, not just those will full overlaps.
"""
# TEST CASES
...
with open('/home/user/AoC2022/Day4/input.lst') as rucksack_file:
    for row in rucksack_file:
        elves = row.split(',')

        # Need to add 1 her because only Start (Not End) is inclusive in Python's range function.
